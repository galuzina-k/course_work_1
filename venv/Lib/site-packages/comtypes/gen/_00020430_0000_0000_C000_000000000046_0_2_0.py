...
IFontDisp = Font
__all__ = [ 'Default', 'Color', 'OLE_TRISTATE',
           'LoadPictureConstants', 'OLE_YPOS_CONTAINER', 'StdFont',
           'FONTSIZE', 'VgaColor', 'IPicture', 'Checked',
           'FONTSTRIKETHROUGH', 'IPictureDisp', 'StdPicture',
           'IFontEventsDisp', 'OLE_XSIZE_CONTAINER',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_XPOS_CONTAINER',
           'OLE_CANCELBOOL', 'OLE_YSIZE_CONTAINER', 'OLE_COLOR',
           'OLE_HANDLE', 'FONTITALIC', 'OLE_XSIZE_PIXELS', 'FONTBOLD',
           'Font', 'OLE_YPOS_PIXELS', 'FONTUNDERSCORE',
           'OLE_XPOS_HIMETRIC', 'OLE_YSIZE_PIXELS', 'Gray',
           'OLE_YPOS_HIMETRIC', 'OLE_YSIZE_HIMETRIC',
           'OLE_XPOS_PIXELS', 'Monochrome', 'OLE_OPTEXCLUSIVE',
           'Unchecked', 'FontEvents', 'OLE_XSIZE_HIMETRIC', 'IFont',
           'IFontDisp', 'Picture', 'FONTNAME']
